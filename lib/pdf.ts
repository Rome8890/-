...
<body>
  ...
  <div class="law-box">
    <strong>① 공동주택관리법 시행령 제31조 제7항</strong><br>
    "장기수선충당금은 해당 주택의 소유자가 부담한다. 임차인이 이를 납부한 경우,
    임대차가 종료된 때에 임대인(소유자)에게 반환을 청구할 수 있다."
  </div>

  <div class="law-box">
    <strong>② 대법원 2004. 1. 27. 선고 2003다62059 판결</strong><br>
    "장기수선충당금은 소유자 부담이 원칙이므로, 임차인이 납부한 경우
    임대차계약 종료 시 임대인에게 반환을 청구할 권리가 있다."
  </div>
  ...
  <div class="warning-box">
    ※ 상기 기한 내 반환이 이루어지지 않을 경우, 소액심판 청구(인지대 1만원, 승소율 95%+)
    등 법적 절차를 진행할 수밖에 없음을 알려드립니다.
  </div>
